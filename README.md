...
[![Build Status](https://travis-ci.org/penobit/idb.svg?branch=master)](https://travis-ci.org/penobit/idb)
[![Total Downloads](https://poser.pugx.org/penobit/idb/downloads)](https://packagist.org/packages/penobit/idb)
[![Daily Downloads](https://poser.pugx.org/penobit/idb/d/daily)](https://packagist.org/packages/penobit/idb)
...
iDB has the ability to run database "transactions", in which all database
...
&copy; 2020 [Penobit](http://penobit.com/). Licensed under MIT license.
